                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive pt-3">
                                <form method="POST" action="{{route('create.stripe.connect.account')}}">
                                    @csrf
                                    <input type="email" name="stripe_email" value="{{\Illuminate\Support\Facades\Auth::guard('admin')->user()->email}}" disabled>
