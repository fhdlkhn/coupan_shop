            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-content-wrapper">
                        ...
                        <h1>BUSINESS OWNERSHIP DISCOUNT EXCHANGE</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 d-flex flex-column justify-content-between">
                    <div class="snet-started-company-box flex-grow-1 d-flex flex-column">
                        <div>
                            <div class="img-box">
                                <img src="{{ asset('front/images/banners/company-started-1.svg') }}" alt="company-started">
                            </div>
                            <h4>BUY</h4>
                            <p>We enable businesses to sell and trade permanent discounts, generating quick cash and increasing profits by engaging customers who invest in their success</p>
                        </div>
                        <div class="mt-auto">
                            <button class="ly-button-inv">
                                <a href="{{ \Illuminate\Support\Facades\Auth::guard('admin')->check() ? url('admin/add-edit-product') : '#' }}">Post Listings</a>
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="tabler:chevron-right" class="iconify iconify--tabler">
                ...
                <div class="col-lg-5 d-flex flex-column justify-content-between">
                    <div class="snet-started-company-box flex-grow-1 d-flex flex-column">
                        <div>
                            ...
                            <h4>Sell</h4>
                            <p>Imagine a system where professional athletes can't be traded to build loyalty, and discount buyers stay committed to their chosen brand, providing valuable feedback and potentially gaining from the brand's success.</p>
                        </div>
                        <div class="mt-auto">
                            <button class="ly-button-inv">
                                <a href="{{ route('search.product') }}">View Inventory</a>
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="tabler:chevron-right" class="iconify iconify--tabler">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 6l6 6l-6 6"></path>
                                </svg>
                            </button>
