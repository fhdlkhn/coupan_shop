                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="main-img-box">
                                    <img src="{{asset('front/images/banner_images/register.png')}}" alt="main-img">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="ly-form-area">
                                    <h3 class="title">Welcome to Our company!</h3>
                                    <p class="desc">Register now and start your adventure.</p>
                                    ...
                                    <div class="social-login-box">
                                        <a href="{{ url('auth/facebook') }}">
                                            ...
                                            <small>Register with Facebook</small>
                                        </a>
                                    </div>
                                    ...
                                    <form action="{{ url('/vendor/register') }}" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" id="your-name" name="name" class="form-control" placeholder="Your name..." aria-label="name">
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="user-name" class="form-label">Username</label>
                                                <input type="text" id="user-name" name="username" class="form-control" placeholder="Your Username..." aria-label="username">
                                            </div>
                                            <div class="col-lg-12">
                                                <label for="email" class="form-label">Email</label>
                                                <input type="text" id="email" name="email" class="form-control" placeholder="Email..." aria-label="email">
                                            </div>
                                            <div class="col-lg-6 password-field">
                                                <label for="password" class="form-label">Password</label>
                                                <input type="password" id="vendorpassword" name="password" class="form-control" placeholder="Your Passowrd..." aria-label="password">
                                                <span onclick="changePassword1()"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="currentColor"><path d="M12 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6"/><path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69c.12.362.12.752 0 1.113c-1.487 4.471-5.705 7.697-10.677 7.697c-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113M17.25 12a5.25 5.25 0 1 1-10.5 0a5.25 5.25 0 0 1 10.5 0" clip-rule="evenodd"/></g></svg></span>
                                            </div>
                                            <div class="col-lg-6 password-field">
                                                <label for="password_confirmation" class="form-label">Confirm Password</label>
                                                <input type="password" id="register_pass" name="password_confirmation" class="form-control" placeholder="Your Passowrd..." aria-label="password">
                                                <span onclick="changePassword()"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" ><g fill="currentColor"><path d="M12 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6"/><path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69c.12.362.12.752 0 1.113c-1.487 4.471-5.705 7.697-10.677 7.697c-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113M17.25 12a5.25 5.25 0 1 1-10.5 0a5.25 5.25 0 0 1 10.5 0" clip-rule="evenodd"/></g></svg></span>
                                            </div>
                                            <div class="col-lg-12">
