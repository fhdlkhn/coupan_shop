...
Route::get('orders/invoice/download/{id}', 'App\Http\Controllers\Admin\OrderController@viewPDFInvoice');
 Route::get('payout', 'App\Http\Controllers\Admin\PayoutController@payout')->name('payout.index');
    Route::POST('save-payout', 'App\Http\Controllers\Admin\PayoutController@savePayout')->name('save.payout');
    Route::POST('update-payout', 'App\Http\Controllers\Admin\PayoutController@updatePayout')->name('update.payout');
    Route::POST('add-dispute', 'App\Http\Controllers\Front\DisputeController@addDispute')->name('add.dispute');
...
Route::namespace('App\Http\Controllers\Front')->group(function() {
    ...
    Route::post('countries_and_flags', 'VendorController@index'); // the register HTML form submission in vendor login_register.blade.php page
    ...
    Route::get('all-listings', 'ProductsController@allListings')->name('all.listings');
    ...
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::match(['GET', 'POST'], 'user/account', 'UserController@userAccount')->name('user.account');

        // User Account Update Password HTML Form submission via AJAX. Check front/js/custom.js
        Route::post('user/update-password', 'UserController@userUpdatePassword');

        // Coupon Code redemption (Apply coupon) / Coupon Code HTML Form submission via AJAX in front/.blade.php, check front/js/custom.js
