...
$(document).ready(function() {
    ...
    $('#checkPincode').click(function() {
        ...
        // Location Carousel
    $('.ly-location-carousel').owlCarousel({
        loop:true,
        nav:true,
        dots: false,
        navText : ["<span class='iconify' data-icon='octicon:arrow-left-16'></span>","<span class='iconify' data-icon='octicon:arrow-right-16'></span>"],
        margin:21,
...
$(document).ready(function() {
    ...
    $('.ly-related-location-carousel').owlCarousel({
        loop:false,
        nav:false,
        margin:21,
        responsiveClass:true,
...
//TOGGLING NESTED ul
$(".ly-loged-in-drop-down .selected a").click(function() {
    $(".ly-loged-in-drop-down .options").toggle();
});

//SELECT OPTIONS AND HIDE OPTION AFTER SELECTION
$(".ly-loged-in-drop-down .options .list li a").click(function() {
    var text = $(this).html();
    $(".ly-loged-in-drop-down .selected a span").html(text);
    $(".ly-loged-in-drop-down .options").hide();
}); 
