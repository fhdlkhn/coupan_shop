...
class Product extends Model
{
    ...
    public static function getDiscountAttributePrice($product_id, $size = NULL) { // this method is called (used) in front/products/detail.blade.php and cart_items.blade.php and in applyCoupon() method in Front/ProudctsController.php
        ...
        return array(
            'product_price' => $proDetails['product_price'], // the original price of that `product_id` and `size` in `products_attributes` table
